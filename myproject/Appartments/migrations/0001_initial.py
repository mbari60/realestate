# Generated by Django 5.0.4 on 2024-07-04 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airbnb', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Appartments.airbnbmodel')),
            ],
        ),
        migrations.AddField(
            model_name='airbnbmodel',
            name='amenities',
            field=models.ManyToManyField(to='Appartments.amenitymodel'),
        ),
        migrations.CreateModel(
            name='ApartmentModel',
            fields=[
                ...
                ('booked', models.BooleanField(default=False)),
                ('photo_url', models.CharField(blank=True, max_length=6000, null=True)),
                ('amenities', models.ManyToManyField(to='Appartments.amenitymodel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('booked', models.BooleanField(default=False)),
                ('apartment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Appartments.apartmentmodel')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
